...
@pytest.mark.unit
def test_claude_stream_extract_raises_runtime_error_on_malformed_json() -> None:
    # Parity with the buffered path (LL-003): when the assembled input_json_delta
    # fragments do not form valid JSON, stream_extract must raise a
